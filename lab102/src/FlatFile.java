...
**/
  public FlatFile readFile(int count, Scanner inFile)
  {
    int sub;
    Record rec = null;
    ...
    while(inFile.hasNext() && sub < count)
    {
...
/*********************************************************************
 * Method to find a record with a key from a <code>String</code>
 *
 *@param the <code>String</code> value that will be used in the search
  * @return the subscript of the record if found, or -1 if not there.
 **/
