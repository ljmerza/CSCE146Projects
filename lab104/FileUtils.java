...
/*********************************************************************
 * FileUtils class of static constants and basic file routines.
 ...
 * @param outFile The <code>PrintWriter</code> output file.
...
/*********************************************************************
 * Method to set the output file given the name of the file.
 * @param outFileName The <code>String</code> name of the output file.
 ...
 * 
 * @param  outFileName the <code>String</code> name of the
 *                     file to open
 ...
 * in methods that have to open files.
 * 
 * @param  inFileName the <code>String</code> name of the file
 *                    to open
