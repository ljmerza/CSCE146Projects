...
**/
  ...
  /*********************************************************************
   * Accessor for the <code>hours</code>.
   *
   * @return the value of <code>hours</code>.
  **/
  ...
  /*********************************************************************
   * Mutator for the <code>hours</code>.
   *
   * @return the value of <code>hours</code>
  **/
    public void setHours(String what)
    {
      this.hours = what;
    } // public void setHours(String what)
...
**/
  public String toString()
  {
    ...
    s = String.format("%-10s %-5s %-9s %4d %18s",
                 ...
                 this.getPhone(),this.getTeaching(),this.getHours());
    return s;
  } // public String toString()
